...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO transaccion_camas(codigo_transaccion,fecha,codigo_cama,numero,created_user,tipo_transaccion) 
                                            VALUES('$codigo_transaccion','$fecha_a','$codigo_cama','$num','$created_user','$tipo_transaccion')")
                                            or die('Error: '.mysqli_error($mysqli));    

           
            if ($query) {
                
                $query1 = mysqli_query($mysqli, "UPDATE camas SET stock        = '$total_stock'
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=camas_transaction&alert=1");
                }
            }   
        }   
    }
