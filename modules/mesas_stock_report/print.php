...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <title>REPORTE DE MESAS Y COLCHONES</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
           DATOS DE REGISTROS DE MESAS Y COLCHONES
        </div>
    <?php  
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle"><small>CÓDIGO DE MESA</small></th>
...
<?php
$filename="datos de registro de mesas.pdf"; 
