...
<section class="content-header">
  <h1>
    <i class="fa fa-file-text-o icon-title"></i>Informe de datos de registro de mesas
  </h1>
  <ol class="breadcrumb">
    <li><a href="?module=start"><i class="fa fa-home"></i> Inicio</a></li>
    <li class="active">informe</li>
    <li class="active"> registro de mesas</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="GET" action="modules/mesas_stock_report/print.php" target="_blank">
          <div class="box-body">
