...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO transaccion_sofas(codigo_transaccion,fecha,codigo_sofa,numero,created_user,tipo_transaccion) 
                                            VALUES('$codigo_transaccion','$fecha_a','$codigo_sofa','$num','$created_user','$tipo_transaccion')")
                                            or die('Error: '.mysqli_error($mysqli));    

           
            if ($query) {
                
                $query1 = mysqli_query($mysqli, "UPDATE sofas SET stock        = '$total_stock'
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=sofas_transaction&alert=1");
                }
            }   
        }   
    }
